      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
        <div className="p-8 border border-gray-200 dark:border-gray-600 dark:bg-gray-800  rounded-xl hover:shadow-lg transition-shadow duration-300 bg-white">
          ...
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
            Our platform quickly connects freelancers and clients based on
            skills, budget, and deadlines, ensuring efficient project starts.
          </p>
        </div>
        <div className="p-8 border border-gray-200  dark:border-gray-600 dark:bg-gray-800 rounded-xl hover:shadow-lg transition-shadow duration-300 bg-white">
          <FaLock className="text-blue-600 w-7 h-7 mb-2" />
          <h3 className="text-xl font-medium text-blue-600 mb-3">
            Secure Payments
          </h3>
          <p className="text-gray-700  dark:text-gray-200 leading-relaxed">
            All payments are securely managed and released only when both
            parties are fully satisfied with the work.
          </p>
        </div>
        <div className="p-8 border border-gray-200  dark:border-gray-600 dark:bg-gray-800 rounded-xl hover:shadow-lg transition-shadow duration-300 bg-white">
          <FaHeadset className="text-blue-600 w-7 h-7 mb-2" />
          <h3 className="text-xl font-medium text-blue-600 mb-3">
            24/7 Support
          </h3>
          <p className="text-gray-700  dark:text-gray-200 leading-relaxed">
